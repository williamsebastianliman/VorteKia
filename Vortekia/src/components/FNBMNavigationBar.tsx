...
function FNBMNavigationBar() {
  const navigate = useNavigate();
  return (
    <div className="bg-black flex justify-between items-center p-4">
      <div className="text-white font-bold">F&B Manager</div>
      <div className="flex gap-5">
        ...
        <button
          className="font-bold text-1xl text-white hover:text-blue-300"
          onClick={() => navigate("/staff/fnbm/groupchat")}
        >
          View Group
        </button>
        <button
          className="font-bold text-1xl text-white hover:text-blue-300"
          onClick={() => navigate("/staff/fnbm/createrestaurantproposal")}
        >
          Restaurant Proposal
        </button>
        <button
...
export default FNBMNavigationBar;
